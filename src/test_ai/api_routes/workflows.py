...
def get_yaml_workflow_definition(
    ...
    try:
        ...
        return {
            ...
            "steps": [
                {"id": step.id, "type": step.type, "params": step.params}
...
def list_workflow_versions(
    ...
    versions = state.version_manager.list_versions(
        workflow_name, limit=limit, offset=offset
    )
...
def compare_workflow_versions(
    ...
    try:
        diff = state.version_manager.compare_versions(
            workflow_name, from_version, to_version
        )
        return {
