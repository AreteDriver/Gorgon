...
from test_ai.security import get_brute_force_protection
...
from test_ai.utils.circuit_breaker import get_all_circuit_stats
...
def metrics_endpoint() -> Response:
    ...
    from test_ai.metrics import PrometheusExporter, get_collector
    ...
    lines.append(
        f"gorgon_app_shutting_down {1 if state._app_state['shutting_down'] else 0}"
    )
