...
def graph_execute(
    ...
    try:
        from test_ai.workflow.graph_executor import ReactFlowExecutor
        from test_ai.workflow.graph_models import WorkflowGraph
                ...
                json.dumps(
                    {
                        "valid": False,
                        "issues": [
                            {"severity": "error", "message": f"Parse error: {e}"}
                        ],
                    },
                    indent=2,
                )
