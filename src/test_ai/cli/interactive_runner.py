...
class InteractiveRunner:
    ...
    def _check_dependencies(self) -> None:
        ...
        if not INQUIRER_AVAILABLE:
            self.output.warning(
                "InquirerPy not installed. Install with: pip install InquirerPy"
            )
    ...
    def _select_workflow(self, category: str) -> Optional[WorkflowTemplate]:
    ...
    def _gather_inputs(self, workflow: WorkflowTemplate) -> Optional[Dict[str, Any]]:
