...
from test_ai.executions.models import (
    Execution,
    ExecutionLog,
    ExecutionMetrics,
    ExecutionStatus,
...
def _skip_auth():
    ...
    with patch("test_ai.api_routes.executions.verify_auth"):
        yield
...
class TestSSEEndpointUnit:
    ...
    def test_stream_returns_404_for_nonexistent(self):
        ...
        with patch("test_ai.api_routes.executions.state") as mock_state:
            mock_state.execution_manager = mock_em
            from test_ai.api_routes.executions import stream_execution
    ...
    def test_completed_execution_sends_done_immediately(self):
        ...
        with patch("test_ai.api_routes.executions.state") as mock_state:
            ...
            async def _run():
                ...
                response = await stream_execution(
                    "exec-stream", mock_request, authorization=None
                )
                events = []
