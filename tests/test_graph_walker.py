...
from test_ai.workflow.graph_models import GraphEdge, GraphNode, WorkflowGraph
...
def _make_graph(nodes, edges):
    ...
    graph_nodes = [
        GraphNode(id=n["id"], type=n.get("type", "agent"), data=n.get("data", {}))
        for n in nodes
    ]
    graph_edges = [
        GraphEdge(
    ...
    return WorkflowGraph(
        id="test", name="Test Graph", nodes=graph_nodes, edges=graph_edges
    )
