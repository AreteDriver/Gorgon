...
class TestWorkflowComposer:
    ...
    def test_execute_sub_workflow(self):
        ...
        with patch("test_ai.workflow.composer.load_workflow", return_value=mock_config):
            with patch("test_ai.workflow.composer.WorkflowExecutor") as MockExecutor:
    ...
    def test_resolve_workflow_graph_detects_cycle(self):
        ...
        with patch("test_ai.workflow.composer.load_workflow", side_effect=mock_load):
