...
class TestNotionClientWrapper:
    ...
    def mock_settings(self):
        ...
        with patch("test_ai.api_clients.notion_client.get_settings") as mock:
    ...
    def mock_notion_client(self):
        ...
        with patch("test_ai.api_clients.notion_client.NotionClient") as mock:
            yield mock

    @pytest.fixture
    def client(self, mock_settings, mock_notion_client):
        """Create a NotionClientWrapper with mocked dependencies."""
        from test_ai.api_clients.notion_client import NotionClientWrapper
    ...
    def test_append_to_page_success(self, client):
        ...
        client.client.blocks.children.append.return_value = {
            ...
            "results": [
                {
                    ...
                    "url": "https://notion.so/page-1",
                    "properties": {
                        "Name": {"title": [{"text": {"content": "Search Result 1"}}]}
                    },
                },
                {
                    "id": "page-2",
                    ...
                    "properties": {
                        "Name": {"title": [{"text": {"content": "Search Result 2"}}]}
                    },
                },
            ]
        }
    ...
    def test_query_database_api_error(self, client):
        ...
        client.client.databases.query.side_effect = MaxRetriesError(
            "API error", attempts=3
        )
    ...
    def test_create_page_api_error(self, client):
        ...
        client.client.pages.create.side_effect = MaxRetriesError(
            "API error", attempts=3
        )
