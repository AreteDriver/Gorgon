...
def mock_streamlit():
    ...
    mod_key = "test_ai.dashboard.cost_dashboard"
...
class TestRenderCostDashboard:
    def test_renders_title(self, mock_streamlit):
        ...
        with patch(
            "test_ai.dashboard.cost_dashboard._get_tracker", return_value=tracker
        ):
            from test_ai.dashboard.cost_dashboard import render_cost_dashboard
    ...
    def test_handles_missing_cost_tracker_module(self, mock_streamlit):
        with patch("test_ai.dashboard.cost_dashboard.CostTracker", None):
            from test_ai.dashboard.cost_dashboard import render_cost_dashboard
...
class TestRenderCostWidget:
    def test_renders_sidebar_content(self, mock_streamlit):
        ...
        with patch(
            ...
            from test_ai.dashboard.cost_dashboard import render_cost_widget
...
class TestOverviewTab:
    def test_provider_breakdown_rendered(self, mock_streamlit):
        ...
        from test_ai.dashboard.cost_dashboard import _render_overview_tab
...
class TestAgentTab:
    def test_agent_costs_displayed(self, mock_streamlit):
        ...
        from test_ai.dashboard.cost_dashboard import _render_agent_tab
...
class TestModelTab:
    def test_model_costs_displayed(self, mock_streamlit):
        ...
        with patch("test_ai.dashboard.cost_dashboard.CostTracker") as mock_ct_class:
            mock_ct_class.PRICING = {"gpt-4": {"input": 30.0, "output": 60.0}}

            from test_ai.dashboard.cost_dashboard import _render_model_tab
...
class TestDetailsTab:
    def test_entries_listed(self, mock_streamlit):
        ...
        from test_ai.dashboard.cost_dashboard import _render_details_tab
...
class TestGetAgentIcon:
    def test_known_roles(self, mock_streamlit):
        from test_ai.dashboard.cost_dashboard import _get_agent_icon
