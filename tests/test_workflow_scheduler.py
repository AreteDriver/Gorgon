...
from test_ai.workflow.executor import ExecutionResult
...
def scheduler(temp_data_dir):
    ...
    with patch("test_ai.workflow.scheduler.BackgroundScheduler") as mock_sched:
...
class TestWorkflowSchedulerInit:
    ...
    def test_init_creates_directories(self, temp_data_dir):
        ...
        with patch("test_ai.workflow.scheduler.BackgroundScheduler"):
