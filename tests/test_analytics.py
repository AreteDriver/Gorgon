...
class TestCollectedData:
    ...
    def test_to_context_string_with_dict(self):
        ...
        data = CollectedData(
            source="metrics",
            collected_at=datetime(2025, 1, 18, 12, 0, tzinfo=timezone.utc),
...
class TestAnalysisResult:
    ...
    def test_to_context_string(self):
        ...
        result = AnalysisResult(
            ...
            analyzed_at=datetime(2025, 1, 18, 12, 0, tzinfo=timezone.utc),
...
class TestTrendAnalyzer:
    ...
    def test_analyze_with_slow_operation(self):
        ...
        data = {
            "metrics": {
                "timing": {"slow_query": {"avg_ms": 2000, "max_ms": 5000, "count": 10}}
            }
        }
    ...
    def test_analyze_with_high_variance(self):
        ...
        data = {
            "metrics": {
                "timing": {"variable_op": {"avg_ms": 100, "max_ms": 500, "count": 10}}
            }
        }
        result = analyzer.analyze(data, {})
    ...
    def test_analyze_healthy_system(self):
        ...
        data = {
            "metrics": {
                "timing": {"fast_op": {"avg_ms": 10, "max_ms": 20, "count": 100}}
            }
        }
        result = analyzer.analyze(data, {})
...
class TestThresholdAnalyzer:
    ...
    def test_above_critical_threshold(self):
        ...
        config = {
            "thresholds": {
                "cpu.usage": {"warning": 80, "critical": 90, "direction": "above"}
            }
        }
    ...
    def test_below_threshold(self):
        ...
        config = {
            "thresholds": {
                "disk.free_gb": {"warning": 20, "critical": 10, "direction": "below"}
            }
        }
        result = analyzer.analyze(data, config)
        assert result.severity == "critical"
...
class TestCompositeAnalyzer:
    ...
    def test_combines_results(self):
        ...
        data = {
            "metrics": {
                "timing": {"op": {"avg_ms": 2000, "max_ms": 3000, "count": 10}}
            },
            "cpu.usage": 95,
        }
        config = {
...
class TestGeneratedReport:
    ...
    def test_to_markdown(self):
        ...
        report = GeneratedReport(
            reporter="test",
            generated_at=datetime(2025, 1, 18, 12, 0, tzinfo=timezone.utc),
...
class TestAlert:
    ...
    def test_to_dict(self):
        ...
        alert = Alert(
            ...
            source="monitoring",
            timestamp=datetime(2025, 1, 18, 12, 0, tzinfo=timezone.utc),
            data={"cpu": 95},
        )
        d = alert.to_dict()
...
class TestAlertGenerator:
    ...
    def test_alert_counter_increments(self):
        ...
        generator = AlertGenerator()
        batch1 = generator.generate(
            {"findings": [{"severity": "warning", "message": "A"}]}, {}
        )
        batch2 = generator.generate(
            {"findings": [{"severity": "warning", "message": "B"}]}, {}
        )
...
class TestPipelineResult:
    ...
    def test_to_dict(self):
        ...
        result = PipelineResult(
            ...
            status="completed",
            started_at=datetime(2025, 1, 18, 12, 0, tzinfo=timezone.utc),
            completed_at=datetime(2025, 1, 18, 12, 5, tzinfo=timezone.utc),
            stages=[
