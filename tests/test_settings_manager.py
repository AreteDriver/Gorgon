...
from test_ai.settings.models import (
...
from test_ai.settings.manager import SettingsManager
...
class TestSettingsManagerPreferences:
    ...
    def test_get_preferences_creates_default_when_not_found(
        self, manager, mock_backend
    ):
