...
from test_ai.errors import APIError, MaxRetriesError, ValidationError
...
from test_ai.utils.retry import (
    RetryConfig,
    RetryContext,
    is_retryable_error,
    with_retry,
...
class TestRetryDecorator:
    ...
    @patch("test_ai.utils.retry.time.sleep")
...
class TestCircuitBreakerTransitions:
    ...
    @patch("test_ai.utils.circuit_breaker.time.monotonic")
...
class TestCircuitBreakerFactory:
    ...
    def setup_method(self):
        ...
        from test_ai.utils import circuit_breaker as cb_mod
...
class TestIdentifierValidation:
    ...
    def test_allow_dots(self):
        ...
        assert (
            validate_identifier("com.example.plugin", allow_dots=True)
            == "com.example.plugin"
        )
