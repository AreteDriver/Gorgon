...
class TestCheckBudgetExceeded:
    ...
    @patch("test_ai.workflow.executor_core.get_task_store", create=True)
...
class TestExecuteWithRetries:
    ...
    def test_success_first_attempt(self):
        ...
        output, tokens, error_msg, retries = exe._execute_with_retries(
            step, "stage", {}, {}
        )
    ...
    @patch("test_ai.workflow.executor_patterns.time.sleep")
