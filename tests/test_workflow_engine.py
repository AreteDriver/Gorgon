...
from test_ai.orchestrator.workflow_engine_adapter import (
    convert_step_type,
...
class TestWorkflowEngineAdapterAdditional:
    ...
    def test_execute_workflow_passes_variables_as_inputs(
        self, mock_settings, simple_workflow
    ):
        with patch(
            "test_ai.orchestrator.workflow_engine_adapter.get_settings"
    ...
    def test_execute_workflow_async_passes_variables(
        self, mock_settings, simple_workflow
    ):
