...
def mock_streamlit():
    ...
    mod_key = "test_ai.dashboard.mcp_page"
...
class TestRenderMcpPage:
    def test_renders_title(self, mock_streamlit):
        ...
        with patch("test_ai.dashboard.mcp_page._get_manager", return_value=manager):
    ...
    def test_handles_missing_mcp_module(self, mock_streamlit):
        with patch("test_ai.dashboard.mcp_page.MCP_AVAILABLE", False):
            from test_ai.dashboard.mcp_page import render_mcp_page
    ...
    def test_handles_manager_init_failure(self, mock_streamlit):
        with patch("test_ai.dashboard.mcp_page._get_manager", return_value=None):
            from test_ai.dashboard.mcp_page import render_mcp_page
...
class TestServerManagement:
    def test_shows_empty_state(self, mock_streamlit):
        ...
        from test_ai.dashboard.mcp_page import _render_server_management
    ...
    def test_test_connection_success(self, mock_streamlit):
        ...
        from test_ai.dashboard.mcp_page import _render_server_row
...
class TestAddServerForm:
    def test_form_renders(self, mock_streamlit):
        manager = _make_manager()
        from test_ai.dashboard.mcp_page import _render_add_server_form

        _render_add_server_form(manager)

        mock_streamlit.subheader.assert_called()
        mock_streamlit.form.assert_called_once_with(
            "add_mcp_server", clear_on_submit=True
        )
...
class TestToolDiscovery:
    def test_no_servers_shows_info(self, mock_streamlit):
        manager = _make_manager(servers=[])
        from test_ai.dashboard.mcp_page import _render_tool_discovery
...
class TestDiscoveredTools:
    def test_empty_tools(self, mock_streamlit):
        from test_ai.dashboard.mcp_page import _render_discovered_tools
...
class TestDiscoveredResources:
    def test_empty_resources_returns_early(self, mock_streamlit):
        from test_ai.dashboard.mcp_page import _render_discovered_resources
...
class TestToolExecution:
    def test_no_servers_shows_info(self, mock_streamlit):
        manager = _make_manager(servers=[])
        from test_ai.dashboard.mcp_page import _render_tool_execution
...
class TestDynamicForm:
    def test_empty_schema(self, mock_streamlit):
        ...
        from test_ai.dashboard.mcp_page import _render_dynamic_form
