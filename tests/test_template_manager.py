...
from test_ai.prompts.template_manager import PromptTemplate, PromptTemplateManager
...
class TestPromptTemplateManagerSave:
    ...
    def test_save_template_creates_valid_json(
...
class TestPromptTemplateManagerLoad:
    ...
    def test_load_template_corrupted_json_returns_none(
        self, manager, temp_templates_dir
    ):
    ...
    def test_load_template_preserves_all_fields(
        self, manager, sample_template, temp_templates_dir
    ):
...
class TestSecurityPathTraversal:
    ...
    def test_save_path_traversal_blocked(self, manager):
        ...
        result = manager.save_template(
            MagicMock(id="../../../etc/passwd", model_dump=lambda: {})
        )
        assert result is False
