...
from test_ai.workflow.approval_store import ResumeTokenStore, reset_approval_store
...
class TestApprovalHandler:
    ...
    def test_handler_returns_awaiting_approval(self, executor, store):
        ...
        with patch(
            "test_ai.workflow.approval_store.get_approval_store",
            return_value=store,
        ):
...
class TestStatusEnums:
    ...
    def test_execution_status_has_awaiting_approval(self):
        ...
        from test_ai.executions.models import ExecutionStatus
