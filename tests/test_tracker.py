...
def mock_metrics_store():
    ...
    with patch("test_ai.monitoring.tracker.MetricsStore") as mock_class:
...
class TestTrackWorkflow:
    ...
    def test_track_workflow_marks_failed_on_exception(
        ...
        mock_metrics_store.complete_workflow.assert_called_with(
            exec_id, "failed", "Test error"
        )
...
class TestTrackStep:
    ...
    def test_track_step_completes_on_success(self, tracker, mock_metrics_store):
        ...
        mock_metrics_store.complete_step.assert_called_with(
            exec_id, "step1", "success", tokens=0
        )
    ...
    def test_track_step_records_tokens(self, tracker, mock_metrics_store):
        ...
        mock_metrics_store.complete_step.assert_called_with(
            exec_id, "step1", "success", tokens=500
        )
