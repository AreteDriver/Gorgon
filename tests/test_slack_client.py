...
from test_ai.api_clients.slack_client import (
    MessageType,
    SlackClient,
    SlackMessage,
)
...
class TestSlackClientInit:
    ...
    @patch("test_ai.api_clients.slack_client.WebClient")
    @patch("test_ai.api_clients.slack_client.AsyncWebClient")
    ...
    @patch("test_ai.api_clients.slack_client.WebClient", None)
