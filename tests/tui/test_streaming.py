...
class TestStreamCompletion:
    ...
    async def test_routes_to_openai(self):
        ...
        with patch("test_ai.tui.streaming._stream_openai") as mock_stream:
    ...
    async def test_routes_to_ollama(self):
        ...
        with patch("test_ai.tui.streaming._stream_ollama") as mock_stream:
    ...
    async def test_routes_to_fallback_for_unknown_type(self):
        ...
        with patch("test_ai.tui.streaming._stream_fallback") as mock_stream:
    ...
    async def test_explicit_system_prompt_takes_precedence(self):
        ...
        with patch("test_ai.tui.streaming._stream_anthropic") as mock_stream:
            ...
            async for chunk in stream_completion(
                provider, messages, system_prompt="explicit"
            ):
                chunks.append(chunk)
    ...
    async def test_falls_back_on_generic_exception(self):
        ...
        with (
            patch(
                "test_ai.tui.streaming._stream_anthropic",
                side_effect=RuntimeError("oops"),
            ),
            patch("test_ai.tui.streaming._stream_fallback") as mock_fallback,
        ):
