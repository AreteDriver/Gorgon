...
class TestCreateProviderManager:
    @patch("test_ai.tui.providers.get_settings")
    def test_registers_anthropic_when_key_set(self, mock_settings):
        mock_settings.return_value = MagicMock(
            anthropic_api_key="sk-ant-test",
            openai_api_key="",
        )
        with patch("test_ai.tui.providers.ProviderManager") as MockManager:
    ...
    def test_no_keys_logs_warning(self, mock_settings):
        ...
        with (
            patch("test_ai.tui.providers.ProviderManager") as MockManager,
            patch("test_ai.tui.providers.logger") as mock_logger,
        ):
            mgr = MockManager.return_value
