...
class TestWorkflowGraph:
    ...
    def test_roundtrip(self):
        ...
        original = WorkflowGraph(
            ...
            edges=[
                GraphEdge(
                    id="e1", source="n1", target="n2", source_handle="true", label="Yes"
                ),
            ],
        )
    ...
    def test_diamond_pattern(self):
        ...
        graph = WorkflowGraph(
            ...
            edges=[
                ...
                GraphEdge(
                    id="e2", source="branch", target="left", source_handle="true"
                ),
                GraphEdge(
                    id="e3", source="branch", target="right", source_handle="false"
                ),
